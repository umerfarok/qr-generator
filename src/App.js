...
function App() {
  const animations = ['autumnLeaves', 'oceanWaves', 'neuralNetwork', 'dnaHelix', 'geometricShapes',"fallingFoodFiesta", 'starryNight', 'floatingBubbles', 'gradientWave', 'particleNetwork', 'galaxySpiral', 'fireflies', 'matrixRain', 'rainbowWaves', 'quantumField', 'electricStorm', 'cosmicDust', 'neonPulse', 'auroraBorealis'];
